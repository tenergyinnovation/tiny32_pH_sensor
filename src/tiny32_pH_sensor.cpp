...
#define PHVALUEADDR 100    //the start address of the pH calibration parameters stored in the EEPROM
#define EEPROM_SIZE 1024

tiny32_pH_sensor::tiny32_pH_sensor()
{
...
float tiny32_pH_sensor::readPH(float voltage, float temperature)
{
...
void tiny32_pH_sensor::calibration(float voltage, float temperature,char* cmd)
{
...
void tiny32_pH_sensor::calibration(float voltage, float temperature)
{
    this->_voltage = voltage;
    this->_temperature = temperature;
...
boolean tiny32_pH_sensor::cmdSerialDataAvailable()
{
...
byte tiny32_pH_sensor::cmdParse(const char* cmd)
{
    byte modeIndex = 0;
...
byte tiny32_pH_sensor::cmdParse()
{
    byte modeIndex = 0;
...
void tiny32_pH_sensor::phCalibration(byte mode)
{
